...
class TestNuageFipRateLimitBaseCreateNegative(base_nuage_fip_rate_limit.NuageFipRateLimitBase):
    """
    ...
    def test_create_fip_with_default_rate_limit_below_min_value(self):
        self.assertRaisesRegexp(lib_exc.BadRequest,
                                MSG_INVALID_INPUT,
                                self._create_fip_with_fip_rate_limit, self.port, -2)
...
class TestNuageFipRateLimitBaseUpdateNegative(base_nuage_fip_rate_limit.NuageFipRateLimitBase):
    """
    Negative tests for the per FIP rate limiting based on the neutron REST API.
    ...
    def test_update_fip_with_default_rate_limit_below_min_value(self):
        self.assertRaisesRegexp(lib_exc.BadRequest,
                                MSG_INVALID_INPUT,
                                self._update_fip_with_fip_rate_limit, self.port, self.fip, -2)
...
class TestNuageFipRateLimitBaseAssociationNegative(base_nuage_fip_rate_limit.NuageFipRateLimitBase):
