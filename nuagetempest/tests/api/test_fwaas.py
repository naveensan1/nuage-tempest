...
class FWaaSExtensionTestJSON(BaseFWaaSTest):
    ...
    def setUp(self):
        ...
        self.os_data.insert_resource(self.fw_rule['name'],
                                    os_data=self.fw_rule,
                                    parent=self.def_net_partition)
        self.fw_policy = self.create_firewall_policy(name='fw-policy-1')
        self.os_data.insert_resource(self.fw_policy['name'],
                                    os_data=self.fw_policy,
                                    parent=self.def_net_partition)
    ...
    def test_list_firewall_rules(self):
        ...
        # VSD verification
        self.os_data.user_data = self.fw_rule['name']
    ...
    def test_create_update_delete_firewall_rule(self):
        ...
        self.os_data.delete_resource('fw-rule-2')
        # Update firewall rule
