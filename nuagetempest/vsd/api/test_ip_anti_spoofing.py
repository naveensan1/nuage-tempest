...
class IpAntiSpoofingVSDBase():
    ...
    def _verify_ingress_egress_rules(self, obj, vsd_pg,
        ...
        if in_rule is None:
            ...
            in_rule = obj.TB.vsd_1.get_ingress_acl_entry(filter=base.get_filter_str('locationID', vsd_pg.id))
        if eg_rule is None:
            LOG.debug('getting egress rules')
            eg_rule = obj.TB.vsd_1.get_egress_acl_entry(filter=base.get_filter_str('locationID', vsd_pg.id))
