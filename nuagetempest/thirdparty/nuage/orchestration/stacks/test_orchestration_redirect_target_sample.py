...
class NeutronRedirectionTargetsTest(nuage_base.NuageBaseOrchestrationTest):
    ...
    def resource_setup(cls):
        ...
        cls.orchestration_client.wait_for_stack_status(cls.stack_id, 'CREATE_COMPLETE')
        resources = (cls.orchestration_client.list_resources(cls.stack_identifier)['resources'])
