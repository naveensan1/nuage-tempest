...
#     LOG.info("executing: '%s %s' with params '%s'", cmd, action, params)
#     LOG.debug("using flags: '%s'", flags)
#
#     ssh_timeout = 10
#     ssh_channel_timeout = 10
#
#     ip_address = "172.31.222.83"
#     username = "root"
#     password = "tigris"
#
...
#
#
# class RemoteClientTestBase(tempest.test.BaseTestCase):
#     # @classmethod
#     # def resource_setup(cls):
#     #     if not CONF.cli.enabled:
#     #         msg = "cli testing disabled"
#     #         raise cls.skipException(msg)
#     #     super(RemoteClientTestBase, cls).resource_setup()
#
#     def __init__(self, *args, **kwargs):
#         self.parser = tempest.cli.output_parser
#         super(RemoteClientTestBase, self).__init__(*args, **kwargs)
#
